...
model.update_single_parameter(dyn1.Dynapse1Parameter("PS_WEIGHT_EXC_F_N",7,80), chip, core)
model.update_single_parameter(dyn1.Dynapse1Parameter("IF_DC_P",6,30), chip, core)
